...
if (mysqli_num_rows($result) > 0) {
  ...
  while ($row = $result->fetch_assoc()) {
    // echo "ID: " . $row["id"] . " - " . $row["Deadline"] . " - " . $row["Matkul"] . " - " . $row['Keyword'] . " - " . $row["Topic"] . "<br><br>";

    echo $row['Keyword'] . $row["Matkul"] . " | " .$row["Deadline"] . "<br>";
    echo $row["Topic"]  . "<br><br>";
  }
}
else {
  echo "Tidak ada task yang harus dikerjakan";
}
